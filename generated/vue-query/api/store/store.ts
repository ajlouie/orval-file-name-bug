...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  getGetInventoryQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getInventory>>, TError, TData> 
}
...
export const placeOrder = (
    order: MaybeRef<Order>, options?: AxiosRequestConfig
...
export const getOrderById = (
    orderId: MaybeRef<number>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<Order>> => {
...
export const getGetOrderByIdQueryKey = (orderId: MaybeRef<number>,) => {
    return ['https:','petstore3.swagger.io','api','v3','store','order',orderId] as const;
    }

    
export const getGetOrderByIdQueryOptions = <TData = Awaited<ReturnType<typeof getOrderById>>, TError = AxiosError<void>>(orderId: MaybeRef<number>, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOrderById>>, TError, TData>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  getGetOrderByIdQueryKey(orderId);
   ...
   return  { queryKey, queryFn, enabled: computed(() => !!(unref(orderId))), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getOrderById>>, TError, TData> 
}
...
export function useGetOrderById<TData = Awaited<ReturnType<typeof getOrderById>>, TError = AxiosError<void>>(
 orderId: MaybeRef<number>, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOrderById>>, TError, TData>, axios?: AxiosRequestConfig}
