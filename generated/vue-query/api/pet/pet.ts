...
export const updatePet = (
    pet: MaybeRef<Pet>, options?: AxiosRequestConfig
...
export const findPetsByStatus = (
    params?: MaybeRef<FindPetsByStatusParams>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<Pet[]>> => {
    params = unref(params);
...
export const getFindPetsByStatusQueryKey = (params?: MaybeRef<FindPetsByStatusParams>,) => {
    return ['https:','petstore3.swagger.io','api','v3','pet','findByStatus', ...(params ? [params]: [])] as const;
    }

    
export const getFindPetsByStatusQueryOptions = <TData = Awaited<ReturnType<typeof findPetsByStatus>>, TError = AxiosError<void>>(params?: MaybeRef<FindPetsByStatusParams>, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof findPetsByStatus>>, TError, TData>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  getFindPetsByStatusQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof findPetsByStatus>>, TError, TData> 
}
...
export function useFindPetsByStatus<TData = Awaited<ReturnType<typeof findPetsByStatus>>, TError = AxiosError<void>>(
 params?: MaybeRef<FindPetsByStatusParams>, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof findPetsByStatus>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const findPetsByTags = (
    params?: MaybeRef<FindPetsByTagsParams>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<Pet[]>> => {
    params = unref(params);
...
export const getFindPetsByTagsQueryKey = (params?: MaybeRef<FindPetsByTagsParams>,) => {
    return ['https:','petstore3.swagger.io','api','v3','pet','findByTags', ...(params ? [params]: [])] as const;
    }

    
export const getFindPetsByTagsQueryOptions = <TData = Awaited<ReturnType<typeof findPetsByTags>>, TError = AxiosError<void>>(params?: MaybeRef<FindPetsByTagsParams>, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof findPetsByTags>>, TError, TData>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  getFindPetsByTagsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof findPetsByTags>>, TError, TData> 
}
...
export function useFindPetsByTags<TData = Awaited<ReturnType<typeof findPetsByTags>>, TError = AxiosError<void>>(
 params?: MaybeRef<FindPetsByTagsParams>, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof findPetsByTags>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getPetById = (
    petId: MaybeRef<number>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<Pet>> => {
    petId = unref(petId);
...
export const getGetPetByIdQueryKey = (petId: MaybeRef<number>,) => {
    return ['https:','petstore3.swagger.io','api','v3','pet',petId] as const;
    }

    
export const getGetPetByIdQueryOptions = <TData = Awaited<ReturnType<typeof getPetById>>, TError = AxiosError<void>>(petId: MaybeRef<number>, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPetById>>, TError, TData>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  getGetPetByIdQueryKey(petId);
   ...
   return  { queryKey, queryFn, enabled: computed(() => !!(unref(petId))), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPetById>>, TError, TData> 
}
...
export function useGetPetById<TData = Awaited<ReturnType<typeof getPetById>>, TError = AxiosError<void>>(
 petId: MaybeRef<number>, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPetById>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const updatePetWithForm = (
    ...
    params?: MaybeRef<UpdatePetWithFormParams>, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<Pet>> => {
    petId = unref(petId);
params = unref(params);
...
export const uploadFile = (
    petId: MaybeRef<number>,
    uploadFileBody: MaybeRef<Blob>,
    params?: MaybeRef<UploadFileParams>, options?: AxiosRequestConfig
