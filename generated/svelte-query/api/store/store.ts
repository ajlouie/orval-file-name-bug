...
export const getGetInventoryQueryOptions = <TData = Awaited<ReturnType<typeof getInventory>>, TError = AxiosError<void>>( options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof getInventory>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetInventoryQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof getInventory>>, TError, TData> & { queryKey: QueryKey }
}
...
export function createGetInventory<TData = Awaited<ReturnType<typeof getInventory>>, TError = AxiosError<void>>(
  options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof getInventory>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getPlaceOrderMutationOptions = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof placeOrder>>, TError,{data: Order}, TContext>, axios?: AxiosRequestConfig}
): CreateMutationOptions<Awaited<ReturnType<typeof placeOrder>>, TError,{data: Order}, TContext> => {
 ...
 * @summary Place an order for a pet.
 */
export const createPlaceOrder = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof placeOrder>>, TError,{data: Order}, TContext>, axios?: AxiosRequestConfig}
 ): CreateMutationResult<
...
export const getGetOrderByIdQueryOptions = <TData = Awaited<ReturnType<typeof getOrderById>>, TError = AxiosError<void>>(orderId: number, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof getOrderById>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetOrderByIdQueryKey(orderId);
   ...
   return  { queryKey, queryFn, enabled: !!(orderId), ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof getOrderById>>, TError, TData> & { queryKey: QueryKey }
}
...
export function createGetOrderById<TData = Awaited<ReturnType<typeof getOrderById>>, TError = AxiosError<void>>(
 orderId: number, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof getOrderById>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getDeleteOrderMutationOptions = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof deleteOrder>>, TError,{orderId: number}, TContext>, axios?: AxiosRequestConfig}
): CreateMutationOptions<Awaited<ReturnType<typeof deleteOrder>>, TError,{orderId: number}, TContext> => {
 ...
 * @summary Delete purchase order by identifier.
 */
export const createDeleteOrder = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof deleteOrder>>, TError,{orderId: number}, TContext>, axios?: AxiosRequestConfig}
 ): CreateMutationResult<
