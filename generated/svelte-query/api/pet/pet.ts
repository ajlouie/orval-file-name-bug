...
export const getUpdatePetMutationOptions = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof updatePet>>, TError,{data: Pet}, TContext>, axios?: AxiosRequestConfig}
): CreateMutationOptions<Awaited<ReturnType<typeof updatePet>>, TError,{data: Pet}, TContext> => {
 ...
 * @summary Update an existing pet.
 */
export const createUpdatePet = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof updatePet>>, TError,{data: Pet}, TContext>, axios?: AxiosRequestConfig}
 ): CreateMutationResult<
...
export const getAddPetMutationOptions = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof addPet>>, TError,{data: Pet}, TContext>, axios?: AxiosRequestConfig}
): CreateMutationOptions<Awaited<ReturnType<typeof addPet>>, TError,{data: Pet}, TContext> => {
 ...
 * @summary Add a new pet to the store.
 */
export const createAddPet = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof addPet>>, TError,{data: Pet}, TContext>, axios?: AxiosRequestConfig}
 ): CreateMutationResult<
...
export const getFindPetsByStatusQueryOptions = <TData = Awaited<ReturnType<typeof findPetsByStatus>>, TError = AxiosError<void>>(params?: FindPetsByStatusParams, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof findPetsByStatus>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getFindPetsByStatusQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof findPetsByStatus>>, TError, TData> & { queryKey: QueryKey }
}
...
export function createFindPetsByStatus<TData = Awaited<ReturnType<typeof findPetsByStatus>>, TError = AxiosError<void>>(
 params?: FindPetsByStatusParams, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof findPetsByStatus>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getFindPetsByTagsQueryOptions = <TData = Awaited<ReturnType<typeof findPetsByTags>>, TError = AxiosError<void>>(params?: FindPetsByTagsParams, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof findPetsByTags>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getFindPetsByTagsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof findPetsByTags>>, TError, TData> & { queryKey: QueryKey }
}
...
export function createFindPetsByTags<TData = Awaited<ReturnType<typeof findPetsByTags>>, TError = AxiosError<void>>(
 params?: FindPetsByTagsParams, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof findPetsByTags>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getGetPetByIdQueryOptions = <TData = Awaited<ReturnType<typeof getPetById>>, TError = AxiosError<void>>(petId: number, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof getPetById>>, TError, TData>, axios?: AxiosRequestConfig}
) => {
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPetByIdQueryKey(petId);
   ...
   return  { queryKey, queryFn, enabled: !!(petId), ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof getPetById>>, TError, TData> & { queryKey: QueryKey }
}
...
export function createGetPetById<TData = Awaited<ReturnType<typeof getPetById>>, TError = AxiosError<void>>(
 petId: number, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof getPetById>>, TError, TData>, axios?: AxiosRequestConfig}
...
export const getUpdatePetWithFormMutationOptions = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof updatePetWithForm>>, TError,{petId: number;params?: UpdatePetWithFormParams}, TContext>, axios?: AxiosRequestConfig}
): CreateMutationOptions<Awaited<ReturnType<typeof updatePetWithForm>>, TError,{petId: number;params?: UpdatePetWithFormParams}, TContext> => {
 ...
 * @summary Updates a pet in the store with form data.
 */
export const createUpdatePetWithForm = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof updatePetWithForm>>, TError,{petId: number;params?: UpdatePetWithFormParams}, TContext>, axios?: AxiosRequestConfig}
 ): CreateMutationResult<
...
export const getDeletePetMutationOptions = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof deletePet>>, TError,{petId: number}, TContext>, axios?: AxiosRequestConfig}
): CreateMutationOptions<Awaited<ReturnType<typeof deletePet>>, TError,{petId: number}, TContext> => {
 ...
 * @summary Deletes a pet.
 */
export const createDeletePet = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof deletePet>>, TError,{petId: number}, TContext>, axios?: AxiosRequestConfig}
 ): CreateMutationResult<
...
export const getUploadFileMutationOptions = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof uploadFile>>, TError,{petId: number;data: Blob;params?: UploadFileParams}, TContext>, axios?: AxiosRequestConfig}
): CreateMutationOptions<Awaited<ReturnType<typeof uploadFile>>, TError,{petId: number;data: Blob;params?: UploadFileParams}, TContext> => {
 ...
 * @summary Uploads an image.
 */
export const createUploadFile = <TError = AxiosError<void>,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof uploadFile>>, TError,{petId: number;data: Blob;params?: UploadFileParams}, TContext>, axios?: AxiosRequestConfig}
 ): CreateMutationResult<
