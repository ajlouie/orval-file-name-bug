...
export const findPetsByStatusQueryStatusDefaultTwo = "available";

export const findPetsByStatusQueryParams = zod.object({
  "status": zod.enum(['available', 'pending', 'sold']).default(findPetsByStatusQueryStatusDefaultTwo).describe('Status values that need to be considered for filter')
})
